...
const spotLight = new THREE.SpotLight(0x78ff00,0.4,10,Math.PI * 0.1);
...
const spotLighCameratHelper = new THREE.CameraHelper(spotLight.shadow.camera);
//spotLighCameratHelper.visible = false
scene.add(spotLighCameratHelper)
